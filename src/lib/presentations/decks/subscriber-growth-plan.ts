...
export const subscriberGrowthPlanDeck: PresentationDeck = {
  ...
  slides: [
...

    {
      ...
      subtitle:
        "Even though these businesses are currently on the vaka plan, the acquisition path itself is highly valuable.",
      stats: [
        { label: "Vaka listers acquired", value: "34" },
      ...
      columns: [
        ...
        },
        {
          ...
          items: [
            ...
            "Later convert vaka users into paid tiers",
          ],
        },
      ],
      closingLine:
...

    {
      ...
      table: {
        ...
        rows: [
          ...
          ["Vaka Listing", "Businesses join the platform"],
      ...
      bullets: [
        "Vakalistings are not failure if they are part of a paid conversion system",
...

    {
      ...
      title: "What we need to improve to convert Vaka plan users into paid subscribers",
      bullets: [
...

    {
      ...
      bullets: [
        ...
        "Create a founding member upgrade campaign for Vaka listers",
