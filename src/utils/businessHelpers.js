...
/**
 * Merge business data from both businesses and business_insights tables
 * @param {Object} businessesData - Data from businesses table
 * @param {Object} businessInsightsData - Data from business_insights table
 * @returns {Object} - Merged business data
 */
export function mergeBusinessData(businessesData = {}, businessInsightsData = {}) {
  return {
    ...
    revenue_band: businessInsightsData.revenue_band,
    is_business_registered: businessInsightsData.is_business_registered,
    top_challenges_array: businessInsightsData.top_challenges_array,
    hiring_intentions: businessInsightsData.hiring_intentions,
    current_funding_source: businessInsightsData.current_funding_source,
    funding_amount_needed: businessInsightsData.funding_amount_needed,
    funding_purpose: businessInsightsData.funding_purpose,
    investment_stage: businessInsightsData.investment_stage,
    investment_exploration: businessInsightsData.investment_exploration,
    community_impact_areas_array: businessInsightsData.community_impact_areas_array,
    support_needed_next_array: businessInsightsData.support_needed_next_array,
    current_support_sources_array: businessInsightsData.current_support_sources_array,
    expansion_plans: businessInsightsData.expansion_plans,
