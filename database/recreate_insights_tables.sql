-- ================================================================
-- RECREATE INSIGHTS TABLES
-- These were accidentally removed during cleanup
-- ================================================================
...
-- ================================================================
-- RLS POLICIES FOR INSIGHTS TABLES
-- ================================================================
...
DO $$
BEGIN
    RAISE NOTICE '=== Insights Tables Recreated ===';
    RAISE NOTICE 'business_insights table created successfully!';
    RAISE NOTICE 'founder_insights table created successfully!';
    ...
    RAISE NOTICE '=== Recreation Complete ===';
END $$;
...
AND table_name IN ('business_insights', 'founder_insights')
