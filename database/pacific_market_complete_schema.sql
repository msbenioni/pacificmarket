-- ================================================================
-- PACIFIC MARKET COMPLETE DATABASE SCHEMA
-- Generated: 2026-03-14
-- Purpose: Complete database structure with all tables, RLS policies, functions, and triggers
-- ================================================================
...
-- USERS TABLE (Extended profiles table)
...
/*
-- Sample profile
INSERT INTO profiles (user_id, email, full_name, country, city) VALUES
...
-- Schema version info
COMMENT ON DATABASE pacific_market IS 'Pacific Market Database Schema v1.0 - Complete business management platform';
...
DO $$
BEGIN
    RAISE NOTICE 'Pacific Market database schema created successfully!';
