-- Simple Role Update - Just Update the Data
-- The 'owner' enum value already exists, so we just need to update the records
...
-- Check the enum values (should show admin, buyer, owner, seller)
